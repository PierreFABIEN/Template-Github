  ...
  <div class="col-12 home-content-brand">
    <div class="row home-content-brand--colonne">
      ...
      <div class="col-12 mx-auto home-content-brand--colonne---subtitle">
        CONTACTEZ N'IMPORTE QUI, N'IMPORTE OÚ...
      </div>
    </div>
  </div>
          ...
          <div class="modal-dialog">
            <div class="modal-content">
              ...
              <div class="modal-body">
                ...
                <p>nous pourrons vous mettre en relation avec l'interlocuteur que vous desirez.</p>
<div class="row">
                <div class="col-12 col-sm-12 blog-content-card--colonne---section">
                  <div class="row">


                  <div class="col-3 blog-content-card--colonne---section----box mx-auto">
