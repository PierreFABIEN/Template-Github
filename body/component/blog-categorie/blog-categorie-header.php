<div class="col-12 col-md-3 blog-categorie-side-bar">
  <div class="col-12 blog-categorie-side-bar-header">
    <div class="row blog-categorie-side-bar-header--colonne">
      <div class="col-12 blog-categorie-side-bar-header--colonne---logo">
        <div class="col-6 mx-auto blog-categorie-side-bar-header--colonne---logo----box">
          <a href="home.php">
      ...
      <div class="col-12 blog-categorie-side-bar-header--colonne---titre">
        Recherchez un article
      </div>
      <div class="col-10 mx-auto blog-categorie-side-bar-header--colonne---item">
    ...
    <div class="row blog-categorie-side-bar-header--menu">
    ...
    <div class="container mx-auto blog-categorie-side-bar-header-social social-btns">
